...
namespace UnitTestingExample.Tests
{
    ...
    public partial class StringUtilitiesTests
    {
        ...
        public void TestForTooFewWords()
        {
            ...
            // Assert
            throw new NotImplementedException(); // result should have count equal to 4
        }
        ...
        public void TestForEmptySplitPlaces()
        {
            ...
            // Assert
            throw new NotImplementedException(); // the first item should be equivalent to "test"
        }
        ...
        public void TestOrderingWhenCountsAreEqual()
        {
            ...
            // Assert
            throw new NotImplementedException(); // result should contain all items of expected in order
        }
    }
}
