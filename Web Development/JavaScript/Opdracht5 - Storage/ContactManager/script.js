...
let personen = JSON.parse(localStorage.getItem("ppl"));
...
$(document).ready(function () {
    ...
    $("#clearls").on("click",clearLocalstorage) //Debug clear
    $("#savetols").on("click",saveToStorage) //Debug clear
    ...
    function clearLocalstorage(){
        ...
        localStorage.clear("ppl");
        localStorage.setItem("ppl",JSON.stringify(personen_data))
        
   
    }
    function saveToStorage(){
        console.log("save called");
        localStorage.setItem("ppl",JSON.stringify(personen))
    }
